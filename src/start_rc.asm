...
; ------------------------------startCode1:0x2896------------------------------
; ------------------------------startCode1:0x2897------------------------------
base10_itoa proc near
    retn
base10_itoa endp
; ------------------------------startCode1:0x28c1------------------------------
; ------------------------------startCode1:0x28c2------------------------------
base16_itoa proc near
    retn
base16_itoa endp
; ------------------------------startCode1:0x2909------------------------------
; ------------------------------startCode1:0x290a------------------------------
base2_itoa proc near
    retn
base2_itoa endp
; ------------------------------startCode1:0x292a------------------------------
byte_1292B db 0Fh
...
; ------------------------------startCode1:0x3f1d------------------------------
; ------------------------------startCode1:0x3f1e------------------------------
initPicDictionary proc near
    retn
initPicDictionary endp
; ------------------------------startCode1:0x3f51------------------------------
; ------------------------------startCode1:0x3f52------------------------------
sub_13F52 proc near
    retn
...
_aAt db ' at ',0
    db 0
LIBC_DATA_START dw 0
word_19370 dw 0
off_19372 dw offset __exit
word_19374 dw 0
    dw seg startData
    db 4Ch dup(0)
word_193C4 dw 2824h
...
dword_19576 dd 0
    ...
    db 0
    db 0
aR6000StackOverflow db 'R6000',0Dh,0Ah
...
aR6003IntegerDivideBy0 db 'R6003',0Dh,0Ah
    ...
    db 9
    db 0
aR6009NotEnoughSpaceForEn db 'R6009',0Dh,0Ah
...
aRunTimeError db 'run-time error ',0
    db 2
    db 0
aR6002FloatingPointNotLoa db 'R6002',0Dh,0Ah
    db '- floating point not loaded',0Dh,0Ah,0
    db 1
    db 0
aR6001NullPointerAssignme db 'R6001',0Dh,0Ah
    db '- null pointer assignment',0Dh,0Ah,0
    db 0FFh
    db 0FFh
LIBC_DATA_END db 0FFh
    db 0
_word_19656 dw 0
_word_19658 dw 0
_word_1965A dw 0
...
CRT0_BSS_START db ?
    ...
    db ?
    db ?
CRT0_BSS_END db ? ;; 11 bytes in experiment exe,
    db ?
