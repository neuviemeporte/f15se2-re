...
int FAR CDECL gfx_jump_05_drawString(int16 *pageNum, const char *string, int len);
...
int FAR CDECL gfx_jump_11_blitSprite(int16* spritePtr);
...
int FAR CDECL gfx_jump_21(int color);
...
int FAR CDECL gfx_jump_29_switchColor(int16* page_addr, int arg_2, int arg_3, int arg_4, int arg_5, int arg_6, int arg_7);
int FAR CDECL gfx_jump_2a(int arg_0, int arg_1, int arg_2, int arg_3, int arg_4, int arg_5, int arg_6, int arg_7);
...
int FAR CDECL gfx_jump_30_blitToCurrent(int16 pagePtr);
