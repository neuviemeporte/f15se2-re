...
/* dseg:0xab8 */
int16 FAR CDECL gfx_allocPage(int16 pageNum);                      /* slot 0x00: alloc 64K page, returns seg */
...
int16 FAR CDECL gfx_getCurPageSeg();                                                                                                      /* slot 0x10: GETTER returns curPageSeg in AX */
int16 FAR CDECL gfx_blitSprite(struct SpriteParams *spritePtr);                                                                           /* slot 0x11: sprite blit */
...
int16 FAR CDECL gfx_getBufSize();                                                                                                         /* slot 0x17: returns baked constant 64000 (0xFA00) */
void FAR CDECL gfx_setBlitOffset2();                                                                                                      /* slot 0x18: setBlitOffset */
void FAR CDECL gfx_setBlitOffset3();                                                                                                      /* slot 0x19: setBlitOffset (=0x18) */
void FAR CDECL gfx_setBlitOffset(int16 offset);                                                                                           /* slot 0x1a: setBlitOffset */
void FAR CDECL gfx_setBlitOffsetReg();                                                                                                    /* slot 0x1b: register-call tail: blitOffset = AX */
int16 FAR CDECL gfx_getPresetOffset1();                                                                                                   /* slot 0x1c: returns baked constant 0x5580 */
int16 FAR CDECL gfx_getPresetOffset2();                                                                                                   /* slot 0x1d: returns baked constant 0x1950 */
int16 FAR CDECL gfx_getBlitOffset();                                                                                                      /* slot 0x1e: returns live blitOffset (cs:0x1a0) */
...
void FAR CDECL gfx_setColor(int16 color);                                                                                                 /* slot 0x21: set fill/draw color */
...
void FAR CDECL gfx_dirtyRect(int16 *spanBuf, int16 yMin, int16 yMax);                                                                     /* slot 0x25: dirtyRect (reg-called: BX=spanBuf AX=yMin CX=yMax) */
...
void FAR CDECL gfx_switchColor(int16 *pageDesc, int16 x1, int16 y1, int16 x2, int16 y2, int16 oldColor, int16 newColor);                  /* slot 0x29: replace color in rect */
void FAR CDECL gfx_copyRect(int16 srcPage, uint16 srcX, uint16 srcY, int16 dstPage, uint16 dstX, uint16 dstY, int16 width, int16 height); /* slot 0x2a: copyRect between pages */
...
int16 FAR CDECL gfx_getDisplayPage();                                                                                                     /* slot 0x2d: getDisplayPage */
void FAR CDECL gfx_dacCycle();                                                                                                            /* slot 0x2e: DAC fire/colour-cycle animation */
int16 FAR CDECL gfx_setFont(uint16 ch, uint16 fontIdx);                                                                                   /* slot 0x2f: setup font metrics */
void FAR CDECL gfx_blitToCurrent(int16 pagePtr);                                                                                          /* slot 0x30: copy to curPage */
int16 FAR CDECL gfx_getAuxBufSize();                                                                                                      /* slot 0x31: getAuxBufSize */
int16 FAR CDECL gfx_getFreeMem();                                                                                                         /* slot 0x32: DOS free-memory probe */
...
int16 FAR CDECL gfx_getPageSeg();                                                                                                         /* slot 0x38: returns pageSegs[idx] */
void FAR CDECL gfx_setPageBuf();                                                                                                          /* slot 0x39: pageSegs[idx]=val */
int16 FAR CDECL gfx_getRowOffset();                                                                                                       /* slot 0x3a: returns y*320 */
void FAR CDECL gfx_clearPage();                                                                                                           /* slot 0x3b: fill curPage with 0 */
/* dseg:0xbe4 */
void FAR CDECL gfx_setMode13(int16 monoFlag);      /* slot 0x3c: int16 10h mode 13h */
void FAR CDECL gfx_setFadeSteps(int16 steps);      /* slot 0x3d: setFadeSteps */
int16 FAR CDECL gfx_calcRowAddr(int16 y, int16 x); /* slot 0x3e: calcRowAddr */
/* dseg:0xbf3 */
int16 FAR CDECL gfx_getModecode();                /* slot 0x3f: returns 3 (MCGA) */
void FAR CDECL gfx_setOvlVal1(int16 val);         /* slot 0x40: writes ds:0xcc */
void FAR CDECL gfx_setOvlVal2(int16 val);         /* slot 0x41: writes ds:0xce */
int16 FAR CDECL gfx_getModeFlag2();               /* slot 0x42: returns modeFlag */
int16 FAR CDECL gfx_getConst1();                  /* slot 0x43: returns baked constant 1 (cs:0x1d8) */
...
/* dseg:0xc2f */
void FAR CDECL gfx_storeBufPtr(uint16 seg, int16 pageIdx); /* slot 0x4b: pageSegs[idx]=seg */
int16 FAR CDECL gfx_getModeFlag();                         /* slot 0x4c: getModeFlag */
int16 FAR CDECL gfx_getVal2();                             /* slot 0x4d: getter */
int16 FAR CDECL gfx_getVal();                              /* slot 0x4e: getter */
...
void FAR CDECL gfx_getCurPage(int16 page);                 /* slot 0x53: bare RETF no-op */
int16 FAR CDECL gfx_slot54();
int16 FAR CDECL gfx_slot55();
int16 FAR CDECL gfx_slot56();
int16 FAR CDECL gfx_slot57();
int16 FAR CDECL gfx_slot58();
int16 FAR CDECL gfx_slot59();
