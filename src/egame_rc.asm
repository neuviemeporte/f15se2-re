...
LAB_1000_075d:
    ...
    neg AX
    mov [9620h],AX
    cmp word ptr [961ch],1h
    jz LAB_1000_076f
    jmp LAB_1000_0a94
LAB_1000_076f:
    mov word ptr [694eh],0h
    les BX,dword ptr [6740h]
    cmp word ptr ES:[BX + 3eh],4h
    jnz LAB_1000_079a
    mov word ptr ES:[BX + 3eh],2h
    mov word ptr [0e3ah],1h
    or byte ptr [694fh],10h
    les BX,dword ptr [9df6h]
...
LAB_1000_079a:
    ...
    jnz LAB_1000_07b7
LAB_1000_07b1:
    mov word ptr [5d5ah],1h
LAB_1000_07b7:
    call sub_11F3E
    mov word ptr [0e40h],0h
    mov word ptr [0e48h],1h
    mov AX,0ffffh
    mov [0e44h],AX
    mov [0e42h],AX
    sub AX,AX
    ...
    mov [0e46h],AX
    mov [0e50h],AX
    mov word ptr [7e8h],2710h
    mov word ptr [96e0h],0h
    mov word ptr [182h],1h
    mov word ptr [9bach],1h
    sub AX,AX
    push AX
    call _sub_11A88
    add SP,2h
    mov word ptr [505ah],0ch
    mov word ptr [814h],4h
    call sub_1DAAE
    mov word ptr [5b3ah],1h
    mov word ptr [5b3ch],1h
    les BX,dword ptr [6740h]
...
LAB_1000_0864:
    ...
    shl AX,CL
    cwd
    sub word ptr [8f2ah],AX
    sbb word ptr [8f2ch],DX
    or byte ptr [694eh],8h
    jmp LAB_1000_089e
LAB_1000_088e:
    mov AX,708h
    imul word ptr [86f8h]
    cwd
    sub word ptr [8f48h],AX
    sbb word ptr [8f4ah],DX
LAB_1000_089e:
    call sub_118F6
    sub AX,AX
    push AX
    ...
    mov word ptr [804h],3e8h
    cmp word ptr [808h],0h
    jz LAB_1000_0918
    cmp word ptr [0e3ah],0h
    jnz LAB_1000_0918
    jmp LAB_1000_0a14
LAB_1000_0918:
    mov AX,[9620h]
    sub AX,word ptr [178h]
    cmp AX,8000h
    jnc LAB_1000_0929
    mov AX,1h
    jmp LAB_1000_092c
...
LAB_1000_092c:
    mov [86f8h],AX
    mov word ptr [5820h],7d0h
    mov word ptr [8094h],1fa4h
    mov word ptr [5830h],64h
    call _sub_15FDB
    or byte ptr [694eh],1h
    and byte ptr [694eh],0f7h
    les BX,dword ptr [6740h]
    mov AX,word ptr ES:[BX + 32h]
...
LAB_1000_0a14:
    ...
    cmp word ptr ES:[BX + 38h],6h
    jz LAB_1000_0a7a
    or byte ptr [898eh],2h
    mov word ptr [897ch],834h
    mov word ptr [8990h],2bch
    mov AX,[9610h]
    mov [8978h],AX
    mov AX,50h
    imul word ptr [86f8h]
    add AX,word ptr [9620h]
    mov [897ah],AX
    mov AX,[8978h]
    sub DX,DX
    mov CL,5h
...
LAB_1000_0bf3:
    ...
    mov [86fah],AX
    mov AX,[0e5ch]
    cmp word ptr [0e38h],AX
    jnz LAB_1000_0c1b
    cmp word ptr [0e3ah],0h
    jnz LAB_1000_0c15
    mov word ptr [95e0h],0h
LAB_1000_0c15:
    mov word ptr [0e5ch],0ffffh
LAB_1000_0c1b:
    cmp word ptr [0e40h],0h
    jz LAB_1000_0c26
    dec word ptr [0e40h]
LAB_1000_0c26:
    cmp word ptr [0e3eh],0h
    jz LAB_1000_0c46
    mov AX,[0e3eh]
    cmp word ptr [0e38h],AX
    jnz LAB_1000_0c46
    mov word ptr [0e3eh],0h
    mov AX,2h
    push AX
    call sub_1DA5F
    add SP,2h
LAB_1000_0c46:
    test byte ptr [0e38h],7h
    jz LAB_1000_0c50
    jmp LAB_1000_0f3b
LAB_1000_0c50:
    mov AX,[98bah]
    mov [0e50h],AX
    mov word ptr [673eh],7fffh
    mov word ptr [BP + -0ah],0h
    jmp LAB_1000_0c66
LAB_1000_0c63:
    inc word ptr [BP + -0ah]
...
LAB_1000_0cbc:
    ...
    mov [180h],AX
LAB_1000_0cdc:
    cmp byte ptr [0e38h],0h
    jnz LAB_1000_0d20
    cmp word ptr [0e38h],0h
    jz LAB_1000_0d20
    mov AX,0fffch
    cwd
    add AX,word ptr [9df6h]
    adc DX,0h
    mov CX,0ch
    shl DX,CL
    add DX,word ptr [9df8h]
    mov ES,DX
    mov BX,AX
...
LAB_1000_0f29:
    ...
    mov AX,[9624h]
    mov [96f0h],AX
    mov word ptr [9624h],0h
LAB_1000_0f3b:
    cmp word ptr [673eh],200h
    jl LAB_1000_0f4f
    mov AX,[581eh]
    cmp word ptr [960eh],AX
    jz LAB_1000_0f4f
    jmp LAB_1000_128d
LAB_1000_0f4f:
    mov word ptr [960eh],0h
    mov word ptr [674ch],0a0h
    mov word ptr [6950h],800h
    mov BX,word ptr [98bah]
    mov CL,4h
    shl BX,CL
    test word ptr [BX + 81b4h],800h
    jz LAB_1000_0f77
    mov word ptr [6950h],400h
LAB_1000_0f77:
    mov SI,word ptr [98bah]
    mov CL,4h
    shl SI,CL
    test word ptr [SI + 81b4h],200h
    jz LAB_1000_0fef
    mov word ptr [960eh],80h
    mov word ptr [674ch],100h
    mov word ptr [6950h],3c0h
    cmp word ptr [581eh],80h
    jnz LAB_1000_0fef
    cmp word ptr [81aah],50h
    jle LAB_1000_0fef
    mov AX,[9620h]
    sub AX,word ptr [SI + 81b0h]
    mul word ptr [86f8h]
...
LAB_1000_0fef:
    ...
    jnz LAB_1000_1004
    add byte ptr [674dh],1h
    add byte ptr [6951h],2h
LAB_1000_1004:
    mov AX,[9610h]
    mov BX,word ptr [98bah]
    mov CL,4h
...
LAB_1000_1048:
    mov word ptr [960eh],0h
    mov word ptr [0e52h],0h
    jmp LAB_1000_1132
LAB_1000_1057:
    mov word ptr [0e52h],1h
    cmp word ptr [81aah],1h
    jle LAB_1000_1067
    jmp LAB_1000_1132
LAB_1000_1067:
    test byte ptr [0e38h],7h
...
LAB_1000_1090:
    ...
    jmp LAB_1000_1132
LAB_1000_1099:
    mov word ptr [0e3ch],1h
    mov word ptr [0e56h],1h
    mov AX,[0e64h]
    inc word ptr [0e64h]
    ...
    call tempStrcpy
    add SP,2h
    mov word ptr [806h],0h
    mov word ptr [0e62h],0h
    mov AX,4h
    push AX
    call sub_1DA5F
    add SP,2h
...
LAB_1000_11f4:
    mov word ptr [8094h],1518h
    mov AX,[5820h]
    sub AX,word ptr [960eh]
    sub DX,DX
    div word ptr [BP + -0ah]
    sub word ptr [5820h],AX
    mov AX,[960eh]
    db 05h, 05h, 00h ; add AX,5h (force imm16 encoding)
    mov SI,AX
    cmp word ptr [5820h],SI
    jnc LAB_1000_121c
    mov word ptr [5820h],SI
LAB_1000_121c:
    mov SI,word ptr [98bah]
    mov CL,4h
    shl SI,CL
...
LAB_1000_128b:
    jmp LAB_1000_1299
LAB_1000_128d:
    mov word ptr [0e56h],0h
    mov word ptr [0e52h],0h
LAB_1000_1299:
    cmp word ptr [0e52h],0h
    jnz LAB_1000_1312
    cmp word ptr [581eh],0h
    jnz LAB_1000_130c
    les BX,dword ptr [6740h]
    cmp word ptr ES:[BX + 40h],0h
    jnz LAB_1000_12c0
    cmp word ptr [96e0h],4h
    jg LAB_1000_12c0
    cmp word ptr [7e8h],0h
    jnz LAB_1000_130a
LAB_1000_12c0:
    cmp word ptr [958ch],0h
    jnz LAB_1000_130a
    cmp word ptr [81aah],32h
    jle LAB_1000_130a
    mov AX,2h
    push AX
    sub AX,AX
...
LAB_1000_130a:
    jmp LAB_1000_1312
LAB_1000_130c:
    mov word ptr [0e64h],1h
LAB_1000_1312:
    cmp byte ptr [70aah],0h
    jz LAB_1000_1366
    test byte ptr [95e0h],80h
    jnz LAB_1000_1366
    les BX,dword ptr [6740h]
    cmp word ptr ES:[BX + 40h],0h
    jz LAB_1000_135a
    cmp word ptr [5820h],0h
    jz LAB_1000_135a
    mov AX,2h
    push AX
    sub AX,AX
...
LAB_1000_1366:
    ...
    test word ptr [BX + 81b4h],200h
    jz LAB_1000_1394
    cmp word ptr [673eh],500h
    jge LAB_1000_1394
    mov AH,byte ptr [86f8h]
    sub AL,AL
    cwd
    mov CX,word ptr [814h]
    idiv CX
    add AX,word ptr [97f0h]
    and AH,0fh
    jmp LAB_1000_1396
LAB_1000_1394:
    sub AX,AX
...
LAB_1000_13fb:
    ...
    imul word ptr [814h]
    shl AX,1h
    sub word ptr [505ah],AX
    cmp word ptr [505ah],4h
    jnc LAB_1000_1424
    mov word ptr [505ah],4h
LAB_1000_1424:
    mov AX,0ffh
    push AX
    mov AX,1h
...
FUN_1000_1720:
    ...
    mov AX,word ptr [SI + 9d06h]
    add AX,word ptr [581eh]
    db 2Dh, 02h, 00h ; sub AX,2h (force imm16 encoding)
    mov word ptr [SI + 9d00h],AX
    mov word ptr [6738h],1h
    jmp LAB_1000_1801
FUN_1000_17e8:
    mov BX,word ptr [BP + -0ch]
    mov AX,BX
...
sub_118D5 proc near
    push BP
    mov BP,SP
    cmp word ptr [96f2h],0h
    jle LAB_1000_18f2
    cmp word ptr [8c2ch],-10h
    jle LAB_1000_18eb
    sub word ptr [8c2ch],0ch
LAB_1000_18eb:
    mov AX,[8c2ch]
    add word ptr [96f2h],AX
LAB_1000_18f2:
    mov SP,BP
    pop BP
    ret
...
LAB_1000_1958:
    ...
    mov CH,AL
    sub CL,CL
    mov word ptr [66c0h],CX
    mov word ptr [6730h],0h
    pop SI
    mov SP,BP
    pop BP
    ret
...
LAB_1000_19f2:
    mov word ptr [804h],3e8h
    mov word ptr [7e8h],2710h
    mov word ptr [7eeh],12h
    mov word ptr [7ech],0ch
    call _sub_11A18
    call sub_1606C
    call _sub_15FDB
    pop SI
...
_sub_11A88 proc near
    ...
    jmp LAB_1000_1b32
LAB_1000_1a96:
    mov BX,word ptr [5a84h]
    mov word ptr [BX + 4h],0h
    mov BX,word ptr [0e9ah]
    shl BX,1h
...
sub_11BC3 proc near
    ...
    jmp LAB_1000_1bf9
LAB_1000_1bd0:
    cmp word ptr [0e5ch],-1h
    jz LAB_1000_1bd9
    jmp LAB_1000_1bf9
LAB_1000_1bd9:
    mov AX,word ptr [BP + 4h]
    mov [977eh],AX
    cmp word ptr [0e5eh],1h
    jnz LAB_1000_1beb
    mov AX,3h
    jmp LAB_1000_1bee
LAB_1000_1beb:
...
sub_11C21 proc near
    ...
    jmp LAB_1000_1d0c
LAB_1000_1c31:
    mov word ptr [806h],1f4h
    mov word ptr [0e5eh],2h
    mov AX,3h
    push AX
    call randlmul
    add SP,2h
...
LAB_1000_1df1:
    ...
    jle LAB_1000_1e0a
    mov byte ptr [66dch],2eh
    mov byte ptr [66ddh],0h
LAB_1000_1e0a:
    mov SP,BP
    pop BP
    ret
...
sub_122B8 proc near
    ...
    mov [0a008h],AX
    mov word ptr [0a00ah],DX
    mov AX,word ptr [BP + 0ch]
    mov DX,word ptr [BP + 0eh]
    mov [0a00ch],AX
    mov word ptr [0a00eh],DX
    mov AX,word ptr [BP + 10h]
    mov DX,word ptr [BP + 12h]
    mov [0a010h],AX
    mov word ptr [0a012h],DX
    mov AX,[0a008h]
    mov DX,word ptr [0a00ah]
    mov word ptr [BP + 8h],AX
    mov word ptr [BP + 0ah],DX
    mov AX,[0a00ch]
    mov DX,word ptr [0a00eh]
    mov word ptr [BP + 0ch],AX
    mov word ptr [BP + 0eh],DX
    mov AX,[0a010h]
    mov DX,word ptr [0a012h]
...
LAB_1000_2330:
    dec word ptr [98bch]
LAB_1000_2334:
    cmp word ptr [98bch],1h
    jge LAB_1000_233e
    jmp LAB_1000_26af
LAB_1000_233e:
    mov BX,word ptr [98bch]
    shl BX,1h
...
LAB_1000_23f1:
    inc word ptr [BP + -0eh]
LAB_1000_23f4:
    cmp word ptr [98bch],4h
    jz LAB_1000_23fe
    jmp LAB_1000_248a
LAB_1000_23fe:
    cmp word ptr [672ch],2h
    jge LAB_1000_2408
    jmp LAB_1000_248a
LAB_1000_2408:
...
LAB_1000_25a5:
    ...
    mov [198ch],AX
    mov word ptr [198eh],228dh
    mov AX,0h
    mov DX,228dh
    cmp AX,word ptr [198ch]
    jnz LAB_1000_2602
    cmp DX,word ptr [198eh]
    jnz LAB_1000_2602
    mov BX,word ptr [9cf8h]
...
LAB_1000_3274:
    dec word ptr [642eh]
LAB_1000_3278:
    cmp word ptr [642eh],0h
    jl LAB_1000_32b4
    mov SI,word ptr [642eh]
    mov CL,3h
    shl SI,CL
...
LAB_1000_33e9:
    ...
    mov BX,word ptr [9cf8h]
    mov AX,word ptr [BX]
    sub AX,word ptr [19b4h]
    mov [1990h],AX
    mov AX,word ptr [BX + 2h]
    sub AX,word ptr [19b6h]
    mov [1992h],AX
    mov AX,word ptr [BX + 4h]
    sub AX,word ptr [19b8h]
    mov [1994h],AX
    inc word ptr [198ch]
    mov byte ptr [19b2h],0h
    mov word ptr [19b0h],0h
    call far ptr sub_202DA
    les BX,dword ptr [198ch]
    test byte ptr ES:[BX],40h
    jz LAB_1000_3459
    mov byte ptr [19a8h],0h
...
LAB_1000_34d2:
    mov [6438h],AX
    mov AX,word ptr [BP + 8h]
    mov CX,word ptr [98bch]
    shl CX,1h
    sub AX,CX
    db 05h, 08h, 00h ; add AX,8h (force imm16 encoding)
    mov [9792h],AX
    mov AX,1000h
    mov CL,byte ptr [9792h]
    sar AX,CL
    mov [6430h],AX
    db 3Dh, 10h, 00h ; cmp AX,10h (force imm16 encoding)
    jg LAB_1000_34fa
...
LAB_1000_3595:
    ...
    jg LAB_1000_35f6
    mov SI,word ptr [6430h]
    sar SI,1h
    mov AX,word ptr [BP + -0ch]
    imul word ptr [6430h]
    sub AX,word ptr [6434h]
    add AX,SI
    mov word ptr [BP + -14h],AX
    mov AX,word ptr [BP + -0eh]
    imul word ptr [6430h]
    sub AX,word ptr [6436h]
    add AX,SI
    mov word ptr [BP + -4h],AX
    push word ptr [BP + -0eh]
    push word ptr [BP + -0ch]
...
LAB_1000_360a:
    dec word ptr [643ah]
LAB_1000_360e:
    cmp word ptr [643ah],0h
    jl LAB_1000_3632
    mov BX,word ptr [643ah]
    shl BX,1h
    mov AX,word ptr [BX + 18d6h]
    mov [98bch],AX
    cmp word ptr [643ah],1h
    jle LAB_1000_362c
    jmp LAB_1000_34d0
LAB_1000_362c:
    mov AX,40h
...
sub_13694 proc near
    ...
    mov BP,SP
    mov AX,word ptr [BP + 4h]
    sub AX,word ptr [0dch]
    add AX,word ptr [6434h]
    cwd
    mov CX,word ptr [6430h]
    idiv CX
    mov BX,word ptr [BP + 8h]
    mov word ptr [BX],AX
    mov AX,word ptr [BP + 6h]
    sub AX,word ptr [0deh]
    shl AX,1h
    shl AX,1h
    cwd
    mov CX,3h
    idiv CX
    add AX,word ptr [6436h]
    cwd
    mov CX,word ptr [6430h]
    idiv CX
    mov BX,word ptr [BP + 0ah]
...
sub_1374A proc near
    ...
    mov [4cb3h],AX
    inc word ptr [198ch]
    mov BX,word ptr [198ch]
    inc word ptr [198ch]
    mov ES,word ptr [198eh]
    mov AL,byte ptr ES:[BX]
    sub AH,AH
    push AX
...
LAB_1000_37cc:
    ...
    jmp LAB_1000_380a
LAB_1000_37d6:
    add word ptr [198ch],4h
    mov BX,word ptr [198ch]
    add word ptr [198ch],2h
    mov ES,word ptr [198eh]
    cmp word ptr ES:[BX],0h
    jge LAB_1000_37fc
    mov AX,word ptr [BP + -4h]
    mov DX,word ptr [BP + -2h]
    xor word ptr [1a06h],AX
    xor word ptr [1a08h],DX
LAB_1000_37fc:
    add word ptr [198ch],2h
...
sub_13932 proc near
    ...
    jz LAB_1000_3993
    mov word ptr [42d6h],0h
    cmp word ptr [672ch],0h
    jnz LAB_1000_3974
    mov byte ptr [42d8h],1h
LAB_1000_3974:
    cmp byte ptr [42d8h],0h
    jnz LAB_1000_3980
    call far ptr sub_20658
LAB_1000_3980:
    cmp byte ptr [503eh],0h
    jnz LAB_1000_3980
    mov BX,word ptr [BP + 4h]
    push word ptr [BX + 4h]
    call sub_10334
    add SP,2h
LAB_1000_3993:
    mov word ptr [19fch],0h
    mov AX,3000h
    cwd
    mov CX,word ptr [814h]
    idiv CX
    sub word ptr [1a0ah],AX
    pop BP
    ret
    nop
sub_13932 endp
...
LAB_1000_3a0a:
    ...
    dec AX
    mov [4ca9h],AX
    mov word ptr [9dech],192ch
    mov word ptr [9df2h],194ch
    cmp byte ptr [5374h],0h
    jz LAB_1000_3a5c
    add word ptr [9dech],10h
    add word ptr [9df2h],10h
LAB_1000_3a5c:
    cmp byte ptr [812h],0h
    jz LAB_1000_3a68
    add word ptr [9df2h],20h
LAB_1000_3a68:
    mov SP,BP
    pop BP
    ret
...
_otherKeyDispatch proc near
    ...
    mov [0581Ch],AX
    mov [0581Ah],AX
    les BX,dword ptr [06740h]
    cmp word ptr ES:[BX+03Eh],AX
    jnz loc_13FBA
    mov AX,[09620h]
    sub AX,word ptr [0178h]
    cmp AX,08000h
    jnc loc_13FB2
    sub AX,AX
    jmp loc_13FB5
...
loc_13FD3:
    mov [05818h],AX
loc_13FD6:
    mov BX,word ptr [08898h]
    mov CL,04h
    shl BX,CL
    test word ptr [BX+081B4h],0200h
    jz loc_13FEB
    add byte ptr [05819h],04h
loc_13FEB:
    call sub_15411
    call _sub_15FDB
    mov word ptr [0961Ch],01h
loc_13FF7:
    mov word ptr [09762h],00h
    call _kbhit
    or AX,AX
    jz loc_14022
    sub AX,AX
...
loc_1406A:
    mov AX,0Ah
loc_1406D:
    add AX,word ptr [05830h]
    push AX
    call _sub_1CF64
    add SP,06h
    mov [05830h],AX
    call _sub_15FDB
    and byte ptr [0694Eh],0F7h
    jmp loc_1423E
loc_14086:
    mov word ptr [05830h],090h
    call _sub_15FDB
    and byte ptr [0694Eh],0F7h
    jmp loc_1423E
loc_14097:
    mov word ptr [05830h],064h
    call _sub_15FDB
    and byte ptr [0694Eh],0F7h
    jmp loc_140C5
loc_140A7:
    mov word ptr [05830h],00h
    sub AX,AX
    push AX
    mov AX,010h
    push AX
    ...
    jmp loc_1423E
loc_140C0:
    xor byte ptr [0694Eh],08h
loc_140C5:
    test byte ptr [0694Eh],08h
    jnz loc_140EE
    cmp word ptr [0960Eh],00h
    jz loc_140EE
    cmp word ptr [05830h],064h
    jnz loc_140EE
    mov word ptr [08094h],0546h
    mov AX,02h
    push AX
    mov AX,01Ch
    push AX
...
loc_140EE:
    jmp loc_1423E
loc_140F1:
    cmp word ptr [05832h],00h
    jnz loc_14103
    call far ptr sub_2265B
    mov word ptr [05832h],028h
loc_14103:
    jmp loc_1423E
loc_14106:
    mov AX,01h
    ...
    call sub_11B37
    add SP,02h
    mov byte ptr [084h],00h
    jmp loc_1423E
loc_14118:
    cmp word ptr [0812h],00h
    jz loc_14149
    mov AX,067h
    push AX
    mov AX,0140h
    ...
    sub AX,AX
    push AX
    mov BX,word ptr [05AB4h]
    push word ptr [BX]
    mov AX,061h
    push AX
    sub AX,AX
    push AX
    mov BX,word ptr [05A84h]
    push word ptr [BX]
    call far ptr _gfx_jump_2a
    add SP,010h
loc_14149:
...
loc_1423E:
    ...
    dec word ptr [05832h]
loc_14249:
    cmp word ptr [05830h],00h
    jz loc_14265
    cmp word ptr [086F6h],00h
    jnz loc_14265
    mov AX,02h
    push AX
    mov AX,0Eh
    ...
    add SP,04h
loc_14265:
    cmp word ptr [080Eh],00h
    jz loc_14278
    mov byte ptr [056E4h],00h
    mov byte ptr [056E5h],00h
    jmp loc_142B6
loc_14278:
    les BX,dword ptr [09DF6h]
    cmp word ptr ES:[BX+072h],00h
    jz loc_1428A
    call far ptr sub_2267E
    jmp loc_142B6
loc_1428A:
    mov SI,word ptr [05D52h]
    inc SI
    mov AL,[056E8h]
    sub AH,AH
...
loc_142CD:
    ...
    inc word ptr [09CF4h]
loc_142E4:
    push word ptr [0975Eh]
    call _abs
    add SP,02h
    db 05h, 02h, 00h ; add AX,02h (force imm16 encoding)
    imul word ptr [0975Eh]
    neg AX
    shl AX,01h
    mov [0975Eh],AX
    mov AX,06h
    imul word ptr [09CF4h]
    mov [09CF4h],AX
    or AX,AX
    jge loc_14313
    mov CX,02h
...
loc_14313:
    mov AX,[0581Eh]
    cmp word ptr [0960Eh],AX
    jnz loc_14330
    cmp word ptr [09CF4h],00h
    jge loc_14330
    cmp word ptr [0581Ah],00h
    jg loc_14330
    mov word ptr [09CF4h],00h
loc_14330:
    cmp word ptr [081AAh],015Eh
    jle loc_14369
    test byte ptr [0694Eh],01h
    jnz loc_14369
    cmp word ptr [0E3Ch],00h
    jz loc_14369
    mov word ptr [0E3Ch],00h
    or byte ptr [0694Eh],01h
    mov AX,0571Ah
    push AX
    call tempStrcpy
    add SP,02h
...
loc_14369:
    ...
    test byte ptr [0694Eh],08h
    jnz loc_1438F
    or byte ptr [0694Eh],08h
    mov AX,0572Eh
    push AX
    call tempStrcpy
    add SP,02h
loc_1438F:
    cmp word ptr [0975Eh],00h
    jnz loc_1439D
    cmp word ptr [09CF4h],00h
    jz loc_143A3
loc_1439D:
    mov word ptr [0806h],00h
loc_143A3:
    cmp word ptr [0806h],00h
    jnz loc_143AD
    jmp loc_14724
loc_143AD:
    cmp word ptr [0E3Ah],00h
    jz loc_143C5
    mov AX,[06730h]
    db 25h, 0Fh, 00h ; and AX,0Fh (force imm16 encoding)
    mov CX,AX
...
loc_143C7:
    ...
    sub AX,word ptr [05818h]
    add AX,word ptr [095E2h]
    push AX
    call routine_163
    add SP,06h
    shl AX,01h
    ...
    push AX
    mov AX,[0806h]
    sub AX,word ptr [0581Eh]
    mov CL,04h
    shl AX,CL
    sub AX,word ptr [06714h]
    push AX
    call routine_163
    add SP,06h
    mov word ptr [BP-14h],AX
...
loc_145CC:
    ...
    mov word ptr [BP-2Ah],AX
    mov AX,050h
    imul word ptr [05830h]
    cmp AX,word ptr [081AAh]
    jge loc_145F4
    or byte ptr [0694Eh],08h
loc_145F4:
    mov AX,[09620h]
...
loc_1464F:
    ...
    cmp word ptr [081AAh],015Eh
    jge loc_14704
    and byte ptr [0694Eh],0FEh
loc_14704:
    mov AX,[0581Eh]
    cmp word ptr [0960Eh],AX
    jnz loc_14724
    mov word ptr [05830h],00h
    mov word ptr [0975Eh],00h
    or byte ptr [0694Eh],08h
    mov word ptr [09CF4h],00h
loc_14724:
    les BX,dword ptr [06740h]
...
loc_147B3:
    ...
    jg loc_1481B
    mov AX,[08094h]
    cmp word ptr [0804Eh],AX
    jnc loc_1481B
    les BX,dword ptr [06740h]
    cmp word ptr ES:[BX+040h],02h
    jnc loc_1481B
    push word ptr [0581Ch]
    call _abs
    add SP,02h
    cmp AX,03000h
    jge loc_1481B
    cmp word ptr [06738h],00h
    jnz loc_1481B
    mov AX,[06714h]
    sub AX,word ptr [0581Ah]
    sar AX,01h
    ...
    mov [09CF4h],AX
loc_1481B:
    cmp word ptr [0958Ch],00h
    jnz loc_14825
    jmp loc_14958
loc_14825:
    mov word ptr [0975Eh],040h
    push word ptr [0581Ch]
    call _abs
    add SP,02h
    cmp AX,04000h
...
loc_14842:
    ...
    call _sub_1CF64
    add SP,06h
    add word ptr [09790h],AX
    jns loc_14886
    mov word ptr [09790h],00h
    test byte ptr [06730h],07h
    jnz loc_14886
    sub AX,AX
    push AX
    call sub_11B37
    add SP,02h
loc_14886:
    cmp word ptr [0581Eh],00h
    jnz loc_148D1
    cmp word ptr [0E46h],-01h
    jnz loc_148D1
    mov word ptr [0E46h],00h
    mov AX,[09610h]
    mov [081AEh],AX
    mov AX,[09620h]
    mov [081B0h],AX
    ...
    mov AX,[09620h]
    mov [09618h],AX
    mov word ptr [0961Eh],00h
    mov word ptr [06D56h],0FFF8h
    mov AX,02h
    push AX
    push AX
    call makeSound
...
loc_148D1:
    ...
    call makeSound
    add SP,04h
    mov word ptr [0581Ah],0C000h
    mov byte ptr [0582Dh],01h
loc_14958:
    cmp word ptr [096E0h],00h
    jz loc_14984
    mov AX,[096E0h]
    shl AX,01h
    shl AX,01h
    ...
    neg AX
    mov SI,AX
    cmp word ptr [05830h],SI
    jle loc_14984
    mov word ptr [05830h],SI
    or SI,SI
    jge loc_14981
    mov word ptr [05830h],00h
loc_14981:
...
loc_14984:
    ...
    mov CX,word ptr [0814h]
    idiv CX
    add word ptr [086F6h],AX
    mov AX,[086F6h]
    cmp word ptr [05830h],AX
    jle loc_149B1
    inc word ptr [086F6h]
loc_149B1:
    mov AX,[086F6h]
...
loc_149C0:
    ...
    idiv CX
    db 05h, 02h, 00h ; add AX,02h (force imm16 encoding)
    sub word ptr [07E8h],AX
    call sub_1606C
loc_149F4:
    cmp word ptr [07E8h],00h
    jg loc_14A07
    mov word ptr [086F6h],00h
    mov word ptr [07E8h],00h
loc_14A07:
    push word ptr [0581Ch]
    call _abs
    add SP,02h
    ...
    sub AX,DX
    sar AX,01h
    add word ptr [0672Ah],AX
loc_14A38:
    cmp word ptr [0672Ah],080h
    jle loc_14A75
    mov word ptr [0672Ah],080h
    push word ptr [09CF4h]
    sub AX,AX
    push AX
    push word ptr [0581Ch]
    call _abs
...
loc_14BF4:
    ...
    push AX
    call __aNldiv
    add word ptr [08094h],AX
    push word ptr [08094h]
    call _abs
    add SP,02h
    inc AX
    cwd
...
loc_14C70:
    ...
    sub DX,DX
    div word ptr [0814h]
    sub word ptr [08094h],AX
    cmp word ptr [0960Eh],00h
    jz loc_14CCD
    cmp word ptr [08094h],01B0h
    jnc loc_14CCD
    mov word ptr [08094h],00h
loc_14CCD:
    jmp loc_14CE0
loc_14CCF:
    mov AX,[08094h]
...
loc_14D45:
    ...
    mov word ptr [0975Eh],00h
    mov AX,[09CF6h]
    cmp word ptr [081AAh],AX
    jge loc_14D85
    mov word ptr [09CF4h],00h
loc_14D85:
    cmp word ptr [0672Eh],00h
    jz loc_14D9E
    mov AX,0FC00h
    sub AX,word ptr [0581Ah]
    mov [09CF4h],AX
...
loc_14E97:
    mov AX,[0804Eh]
    sub AX,word ptr [08094h]
    shr AX,CL
    sub word ptr [0581Ah],AX
    mov byte ptr [0582Dh],01h
    cmp word ptr [0581Ah],00h
    jl loc_14EB8
    cmp word ptr [0581Eh],0C8h
    jnc loc_14EC6
loc_14EB8:
    mov AX,01h
    push AX
...
loc_14EC6:
    ...
    cmp word ptr [0960Eh],AX
    jnz loc_14F05
    cmp word ptr [0581Ch],00h
    jz loc_14EE1
    mov word ptr [0581Ch],00h
    mov byte ptr [0582Dh],01h
loc_14EE1:
    cmp word ptr [0581Ah],00h
    jl loc_14EF3
...
loc_14EF3:
    cmp word ptr [0672Eh],00h
    jnz loc_14F00
    mov word ptr [0581Ah],00h
loc_14F00:
    mov byte ptr [0582Dh],01h
loc_14F05:
    mov word ptr [0672Eh],00h
    push word ptr [0581Ch]
    call _abs
    add SP,02h
    cwd
...
loc_14F40:
    ...
    add SP,04h
    mov [0A006h],AX
    cmp word ptr [0E62h],00h
    jnz loc_14FCF
    cwd
    mov CX,word ptr [0814h]
    idiv CX
    add word ptr [05820h],AX
    push word ptr [05818h]
    call sub_13B96
    add SP,02h
    push AX
    ...
    idiv CX
    cwd
    add word ptr [08F2Ah],AX
    adc word ptr [08F2Ch],DX
    push word ptr [05818h]
    call sub_13B86
    add SP,02h
    push AX
    ...
    idiv CX
    cwd
    add word ptr [08F48h],AX
    adc word ptr [08F4Ah],DX
loc_14FCF:
    cmp word ptr [05820h],0F230h
    ja loc_14FE0
    mov AX,[05820h]
    cmp word ptr [0960Eh],AX
    jbe loc_14FE6
loc_14FE0:
    ...
    mov [05820h],AX
loc_14FE6:
    cmp word ptr [05820h],0EA60h
    jbe loc_14FF4
    mov word ptr [05820h],0EA60h
loc_14FF4:
    cmp word ptr [05820h],02000h
    jnc loc_15004
    mov AX,[05820h]
    mov [0581Eh],AX
    jmp loc_1502C
loc_15004:
    cmp word ptr [05820h],04000h
    jnc loc_1501C
    mov AX,[05820h]
    sub AX,02000h
    shr AX,01h
...
sub_151F9 proc near
    ...
    sub SP,4h
    inc word ptr [5828h]
    test byte ptr [5828h],7h
    jnz LAB_1000_520f
    mov byte ptr [582dh],1h
LAB_1000_520f:
    mov AX,5806h
    push AX
    push word ptr [BP + 6h]
...
LAB_1000_528c:
    ...
    mov [5818h],AX
LAB_1000_52aa:
    cmp word ptr [57c2h],0h
    jg LAB_1000_52bd
    cmp word ptr [57ceh],0h
    jge LAB_1000_52bd
    add byte ptr [5819h],80h
LAB_1000_52bd:
    cmp word ptr [57c2h],0h
    jle LAB_1000_52d5
    cmp word ptr [57ceh],0h
...
LAB_1000_531a:
    ...
    mov [581ch],AX
LAB_1000_5338:
    cmp word ptr [57c4h],0h
    jg LAB_1000_534b
    cmp word ptr [57c6h],0h
    jge LAB_1000_534b
    add byte ptr [581dh],80h
LAB_1000_534b:
    cmp word ptr [57c4h],0h
    jle LAB_1000_5363
    cmp word ptr [57c6h],0h
...
LAB_1000_53ba:
    ...
    mov [5818h],AX
LAB_1000_53d0:
    cmp word ptr [581ah],38e3h
    jle LAB_1000_53e5
    cmp word ptr [581ah],4001h
    jge LAB_1000_53e5
    mov byte ptr [582dh],1h
LAB_1000_53e5:
    cmp word ptr [581ah],0c71dh
    jge LAB_1000_53fa
    cmp word ptr [581ah],0bfffh
    jle LAB_1000_53fa
    mov byte ptr [582dh],1h
LAB_1000_53fa:
    cmp byte ptr [582ah],0h
    jz LAB_1000_540d
    cmp word ptr [581ch],0h
    jnz LAB_1000_540d
    mov byte ptr [582dh],1h
LAB_1000_540d:
    mov SP,BP
...
sub_15411 proc near
    ...
    call far ptr _sub_20BAE
    add SP,8h
    mov byte ptr [582dh],0h
    mov word ptr [5828h],0h
    mov SP,BP
    pop BP
    ret
sub_15411 endp
...
sub_16172 proc near
    ...
    push DI
    push SI
    cmp word ptr [0e48h],0h
    jz LAB_1000_618a
    mov AX,[0e34h]
    cmp word ptr [978eh],AX
    jz LAB_1000_61ae
LAB_1000_618a:
    cmp word ptr [812h],0h
    jz LAB_1000_61ae
    cmp word ptr [0e48h],0h
    jnz LAB_1000_61ae
    cmp word ptr [97eah],0h
    jnz LAB_1000_61ae
    call sub_1A962
    mov word ptr [968ch],0h
    mov word ptr [968eh],100h
LAB_1000_61ae:
    mov word ptr [BP + -0ah],0h
    jmp LAB_1000_61c5
    db 90h
...
LAB_1000_62fc:
    ...
    shl AX,CL
    mov word ptr [BP + -4h],AX
    mov word ptr [95ceh],0h
LAB_1000_630c:
    cmp word ptr [95e6h],0h
    jl LAB_1000_633c
    mov SI,word ptr [95e6h]
    mov CL,4h
    shl SI,CL
    push word ptr [968eh]
    push word ptr [968ch]
...
LAB_1000_6e0e:
    ...
    jz LAB_1000_6e31
    cmp word ptr [673eh],780h
    jge LAB_1000_6e31
    mov word ptr [BP + -32h],3000h
LAB_1000_6e31:
    mov BX,word ptr [643ch]
    mov CL,5h
    shl BX,CL
...
LAB_1000_71ea:
    ...
    mov AX,word ptr [SI + 8958h]
    mov [961eh],AX
    mov word ptr [6d56h],0fff8h
    mov AX,[0e42h]
    cmp word ptr [BP + -22h],AX
    jnz LAB_1000_7217
    mov word ptr [0e42h],0ffffh
LAB_1000_7217:
...
LAB_1000_7418:
    ...
    add CX,2h
    idiv CX
    mov CX,word ptr [6730h]
    sub CX,word ptr [58aeh]
    cmp CX,AX
    jg LAB_1000_7434
    jmp LAB_1000_74eb
LAB_1000_7434:
...
LAB_1000_813b:
    ...
    call _strcat
    add SP,4h
    mov word ptr [6d56h],8h
    mov word ptr [961eh],0h
    jmp LAB_1000_8199
    db 90h
LAB_1000_8172:
    cmp word ptr [BP + -1ch],8h
...
LAB_1000_87a6:
    ...
    call makeSound
    add SP,4h
    cmp word ptr [9bach],1h
    jnz LAB_1000_87e4
    mov AX,[0e42h]
    cmp word ptr [BP + 4h],AX
    jnz LAB_1000_87e4
    mov word ptr [6d54h],1h
LAB_1000_87e4:
    pop SI
    mov SP,BP
    pop BP
...
LAB_1000_8a14:
    ...
    call _strcpy
    add SP,4h
    mov word ptr [182h],2h
    or byte ptr [694fh],40h
LAB_1000_8a2d:
    mov AX,[694eh]
    and AX,6000h
    cmp AX,6000h
    jnz LAB_1000_8a3e
    mov word ptr [182h],3h
LAB_1000_8a3e:
    mov AX,1h
    pop SI
    pop BP
...
sub_19595 proc near
    push BP
    mov BP,SP
    mov word ptr [97eah],0h
    mov word ptr [9768h],18h
    mov word ptr [9baeh],60h
    mov word ptr [976ah],70h
    mov word ptr [9cf2h],0a8h
    mov word ptr [6718h],48h
    mov word ptr [671ch],38h
    call zoomIn
    mov SP,BP
    pop BP
    ret
...
LAB_1000_983e:
    ...
    mov AX,18h
    push AX
    mov BX,word ptr [5ab4h]
    push word ptr [BX]
    mov AX,70h
    push AX
    mov AX,18h
    push AX
    mov BX,word ptr [5a9ch]
    push word ptr [BX]
    call far ptr _gfx_jump_2a
    add SP,10h
LAB_1000_986a:
...
_sub_19C84 proc near
    ...
    call far ptr _gfx_jump_23
LAB_1000_9d6b:
    mov word ptr [4ca7h],13fh
    mov word ptr [4ca9h],0c7h
    sub AX,AX
    push AX
    call far ptr gfx_jump_1a
    add SP,2h
...
sub_1A1B1 proc near
    push BP
    mov BP,SP
    mov byte ptr [96e3h],0dh
    mov AX,word ptr [BP + 4h]
    mov [96e6h],AX
    mov AX,word ptr [BP + 6h]
    mov [96e8h],AX
    mov byte ptr [96e5h],0h
    mov AX,96e2h
    push AX
    push AX
    mov AX,10h
...
LAB_1000_a291:
    ...
    cmp word ptr [5b3ch],2h
    jge LAB_1000_a2c6
    cmp word ptr [672ch],0h
    jz LAB_1000_a2c6
    mov AX,1h
    mov CL,2h
    sub CL,byte ptr [5b3ch]
    shl AX,CL
    inc AX
    mov word ptr [BP + -16h],AX
LAB_1000_a2c6:
...
LAB_1000_a52b:
    ...
    call _sub_1D190
    add SP,4h
    add AX,word ptr [219ch]
    push AX
    push word ptr [BP + -12h]
    push word ptr [BP + -4h]
    call _sub_1D178
    add SP,4h
    mov CX,word ptr [1fb8h]
    sub CX,AX
    push CX
    push word ptr [219ch]
    push word ptr [1fb8h]
...
sub_1A7C4 proc near
    ...
    sub SP,6h
    push SI
    mov word ptr [9766h],0h
    mov AL,7h
    sub AL,byte ptr [5b3ch]
    mov byte ptr [BP + -6h],AL
    mov AX,word ptr [BP + 4h]
    sub AX,word ptr [9610h]
    mov CL,byte ptr [BP + -6h]
    sar AX,CL
    mov word ptr [BP + -2h],AX
    mov AX,[9620h]
    ...
    add AX,SI
    mov [219ch],AX
    add word ptr [1fb8h],0a0h
    neg AX
    db 05h, 98h, 00h ; add AX,98h (force imm16 encoding)
    mov [219ch],AX
    cmp word ptr [1fb8h],7ch
    jl LAB_1000_a851
    cmp word ptr [1fb8h],0c3h
    jle LAB_1000_a857
LAB_1000_a851:
    mov word ptr [9766h],0ffffh
LAB_1000_a857:
    cmp word ptr [219ch],6bh
    jl LAB_1000_a866
    cmp word ptr [219ch],0ach
    jle LAB_1000_a86c
LAB_1000_a866:
    mov word ptr [9766h],0ffffh
LAB_1000_a86c:
...
sub_1A872 proc near
    ...
    db 2Dh, 03h, 00h ; sub AX,3h (force imm16 encoding)
    mov [5b08h],AX
    mov word ptr [5b0ah],7h
    mov word ptr [5b0ch],7h
    mov AX,5afeh
    push AX
...
sub_1A9F8 proc near
    ...
    sub AX,AX
    mov DX,100h
    sub AX,word ptr [8f48h]
    sbb DX,word ptr [8f4ah]
    push DX
    push AX
    push word ptr [8f2ch]
    push word ptr [8f2ah]
    ...
    add SP,14h
LAB_1000_aa45:
    cmp word ptr [8c22h],0h
    jz LAB_1000_aa50
    dec word ptr [8c22h]
LAB_1000_aa50:
    test byte ptr [0e44h],80h
    jnz LAB_1000_aa6b
    test byte ptr [0e38h],0fh
    jz LAB_1000_aa61
    jmp LAB_1000_abd4
LAB_1000_aa61:
    cmp word ptr [975ah],0h
    jz LAB_1000_aa6b
    jmp LAB_1000_abd4
LAB_1000_aa6b:
    cmp word ptr [97eeh],13h
    jz LAB_1000_aa75
    jmp LAB_1000_abd4
LAB_1000_aa75:
    cmp word ptr [8c22h],0h
...
LAB_1000_aaa3:
    mov AX,64h
    mov CL,6h
    sub CL,byte ptr [80ch]
    shl AX,CL
    mov word ptr [BP + -10h],AX
    cmp word ptr [0e44h],-1h
    jz LAB_1000_ab10
    mov AX,[0e44h]
...
LAB_1000_aaea:
    mov AX,[5818h]
    add AX,word ptr [0a002h]
    sub AX,word ptr [6450h]
    push AX
    call _abs
    add SP,2h
    cmp AX,2000h
    ...
    jmp LAB_1000_ab0e
LAB_1000_ab08:
    mov word ptr [975ah],1h
LAB_1000_ab0e:
    jmp LAB_1000_ab1b
LAB_1000_ab10:
    mov word ptr [975ah],0h
    mov word ptr [BP + -1eh],8300h
LAB_1000_ab1b:
...
LAB_1000_abab:
    ...
    cmp word ptr [0e44h],-1h
    jnz LAB_1000_abc0
    mov word ptr [8c22h],4h
    jmp LAB_1000_abc6
LAB_1000_abc0:
    mov word ptr [0e44h],0ffffh
LAB_1000_abc6:
    jmp LAB_1000_abd4
LAB_1000_abc8:
    mov AX,word ptr [BP + -2ch]
    mov [0e44h],AX
    mov word ptr [6d54h],0h
LAB_1000_abd4:
    mov word ptr [BP + -20h],0h
    jmp LAB_1000_abde
LAB_1000_abdb:
...
LAB_1000_abe7:
    ...
    call sub_1C488
    add SP,6h
    cmp word ptr [9766h],0h
    jge LAB_1000_ac6d
    cmp word ptr [9766h],0ff00h
    jle LAB_1000_ac6d
    mov SI,word ptr [BP + -20h]
    mov CL,3h
    shl SI,CL
...
LAB_1000_acb3:
    test byte ptr [0e42h],80h
    jz LAB_1000_ad05
    cmp word ptr [0e42h],-1h
    jz LAB_1000_ad05
    mov AX,[0e42h]
    db 2Dh, 80h, 00h ; sub AX,80h (force imm16 encoding)
    mov word ptr [BP + -20h],AX
...
LAB_1000_add1:
    ...
    sar word ptr [9766h],CL
    cmp word ptr [9766h],-20h
    jg LAB_1000_ade2
    jmp LAB_1000_aefd
LAB_1000_ade2:
    mov AX,24h
...
LAB_1000_b6d8:
    ...
    jmp LAB_1000_c1b3
LAB_1000_b6e2:
    cmp word ptr [5bb0h],0h
    jz LAB_1000_b6ef
    mov word ptr [5bb0h],0h
LAB_1000_b6ef:
    cmp word ptr [80ch],0h
    jz LAB_1000_b6fb
    mov AX,2h
...
LAB_1000_b6fe:
    ...
    call _sub_19BE1
    add SP,8h
    mov word ptr [644ah],0h
    cmp word ptr [9bach],2h
    jz LAB_1000_b735
    jmp LAB_1000_b8ff
LAB_1000_b735:
    cmp word ptr [95e0h],0h
    jz LAB_1000_b73f
    jmp LAB_1000_b8ff
LAB_1000_b73f:
    cmp word ptr [0e44h],0h
...
LAB_1000_c149:
    ...
    cmp word ptr [97eeh],13h
    jnz LAB_1000_c193
    cmp word ptr [6d54h],0h
    jz LAB_1000_c193
    cmp word ptr [6b52h],0h
    jz LAB_1000_c193
    sub AX,AX
    push AX
    mov AX,20h
...
LAB_1000_c37e:
    ...
    add SP,8h
LAB_1000_c3c4:
    cmp word ptr [1fb8h],14h
    jle LAB_1000_c407
    cmp word ptr [1fb8h],118h
    jge LAB_1000_c407
    cmp word ptr [219ch],0h
    jle LAB_1000_c407
    cmp word ptr [219ch],52h
    jge LAB_1000_c407
    push word ptr [66c2h]
    mov AX,[219ch]
    db 05h, 05h, 00h ; add AX,5h (force imm16 encoding)
...
sub_1C488 proc near
    ...
    mov AX,[8f2ah]
    mov DX,word ptr [8f2ch]
    sub AX,word ptr [894eh]
    sbb DX,word ptr [8950h]
LAB_1000_c4c5:
    sar DX,1h
    rcr AX,1h
    dec CL
...
LAB_1000_c4cf:
    ...
    mov AX,[8f48h]
    mov DX,word ptr [8f4ah]
    sub AX,word ptr [8c24h]
    sbb DX,word ptr [8c26h]
    mov CL,5h
LAB_1000_c4e3:
    sar DX,1h
    rcr AX,1h
...
LAB_1000_c620:
    mov [9766h],AX
    cmp word ptr [1fb8h],0h
    jl LAB_1000_c632
    cmp word ptr [1fb8h],13fh
    jle LAB_1000_c63e
LAB_1000_c632:
    mov AX,[1fb8h]
    mov [644eh],AX
...
LAB_1000_c9f3:
    ...
    mov AX,word ptr [BP + 6h]
    mov DX,word ptr [BP + 8h]
    sub AX,word ptr [8f2ah]
    sbb DX,word ptr [8f2ch]
    mov word ptr [BP + -8h],AX
    mov word ptr [BP + -6h],DX
    mov AX,word ptr [BP + 0ah]
    mov DX,word ptr [BP + 0ch]
    add AX,word ptr [8f48h]
    adc DX,word ptr [8f4ah]
...
LAB_1000_cc42:
    ...
    cmp AX,100h
    jle LAB_1000_cc5e
    mov word ptr [64a2h],100h
LAB_1000_cc5e:
    cmp word ptr [64a2h],4h
    jge LAB_1000_cc6b
    mov word ptr [64a2h],4h
LAB_1000_cc6b:
    mov AX,word ptr [BP + -6h]
    sub AX,word ptr [649eh]
    mov CL,5h
    sar AX,CL
    imul word ptr [64a2h]
    mov word ptr [BP + -16h],AX
    mov AX,word ptr [BP + -0eh]
    sub AX,word ptr [64a4h]
    sar AX,CL
    imul word ptr [64a2h]
    mov word ptr [BP + -0ah],AX
    push word ptr [BP + -16h]
...
LAB_1000_ccaf:
    ...
    shl AX,1h
    shl AX,1h
    add AX,word ptr [649eh]
    mov word ptr [BP + -6h],AX
    mov AX,word ptr [BP + -0ah]
    shl AX,1h
    shl AX,1h
    add AX,word ptr [64a4h]
    mov word ptr [BP + -0eh],AX
    mov AX,[64a0h]
    mov CL,5h
    shl AX,CL
    cwd
    mov CX,word ptr [64a2h]
    idiv CX
    shl AX,1h
    shl AX,1h
    mov word ptr [BP + -8h],AX
...
LAB_1000_d31d:
    mov AX,[960eh]
    cmp word ptr [581eh],AX
    jz LAB_1000_d33f
    xor byte ptr [694eh],1h
    mov word ptr [0e3ch],0h
    mov AX,2h
    push AX
    mov AX,20h
    push AX
...
LAB_1000_d3a2:
    inc word ptr [5d52h]
    cmp word ptr [5d52h],2h
    jle LAB_1000_d3b3
    mov word ptr [5d52h],0h
LAB_1000_d3b3:
    mov AX,5c9dh
    push AX
    mov AX,66c4h
...
LAB_1000_d424:
    ...
    jmp LAB_1000_d88c
LAB_1000_d45c:
    cmp word ptr [0e5ah],1h
    jnz LAB_1000_d47a
    mov word ptr [0e5ah],2h
    mov CX,2h
    mov AX,[814h]
    cwd
    idiv CX
...
LAB_1000_d52a:
    ...
    jmp LAB_1000_d88c
LAB_1000_d530:
    mov word ptr [802h],2h
    cmp word ptr [9bach],2h
    jz LAB_1000_d543
    mov word ptr [6d54h],0h
LAB_1000_d543:
    mov word ptr [9bach],2h
    call selectMissile
    jmp LAB_1000_d88c
LAB_1000_d54f:
    inc word ptr [0e5eh]
    cmp word ptr [0e5eh],2h
    jle LAB_1000_d560
    mov word ptr [0e5eh],0h
LAB_1000_d560:
    mov AX,5cd7h
    push AX
    mov AX,66c4h
...
LAB_1000_d636:
    jmp LAB_1000_d88c
LAB_1000_d639:
    or byte ptr [0e44h],80h
    jmp LAB_1000_d88c
LAB_1000_d641:
    mov word ptr [5d56h],1h
    jmp LAB_1000_d88c
LAB_1000_d64a:
    mov word ptr [5d58h],1h
    jmp LAB_1000_d88c
LAB_1000_d653:
    mov word ptr [95e0h],0h
    jmp LAB_1000_d88c
LAB_1000_d65c:
    mov word ptr [95e0h],44h
    jmp LAB_1000_d88c
LAB_1000_d665:
    mov word ptr [95e0h],42h
    jmp LAB_1000_d88c
LAB_1000_d66e:
    mov word ptr [95e0h],43h
    jmp LAB_1000_d88c
LAB_1000_d677:
    mov word ptr [95e0h],41h
    jmp LAB_1000_d88c
LAB_1000_d680:
    mov word ptr [95e0h],87h
    jmp LAB_1000_d88c
LAB_1000_d689:
    mov word ptr [95e0h],84h
    jmp LAB_1000_d88c
LAB_1000_d692:
    mov word ptr [95e0h],85h
    jmp LAB_1000_d88c
LAB_1000_d69b:
    mov word ptr [95e0h],89h
    jmp LAB_1000_d88c
LAB_1000_d6a4:
    mov word ptr [95e0h],88h
    jmp LAB_1000_d88c
LAB_1000_d6ad:
    mov word ptr [95e0h],8bh
    jmp LAB_1000_d88c
LAB_1000_d6b6:
    cmp word ptr [958ch],0h
    jz LAB_1000_d6c0
...
LAB_1000_d8b0:
    ...
    jmp LAB_1000_d8b0
LAB_1000_d8ba:
    add word ptr [8f48h],AX
    adc word ptr [8f4ah],DX
    jmp LAB_1000_d94b
LAB_1000_d8c5:
    sub AX,AX
    mov DX,2h
...
LAB_1000_d914:
    ...
    jmp LAB_1000_d914
LAB_1000_d91e:
    add word ptr [8f2ah],AX
    adc word ptr [8f2ch],DX
    jmp LAB_1000_d94b
    db 0EBh
    db 21h
LAB_1000_d92a:
...
LAB_1000_d94b:
    cmp word ptr [958ch],0h
    jz LAB_1000_d958
    mov word ptr [95e0h],8ch
LAB_1000_d958:
    cmp word ptr [5d54h],0h
    jle LAB_1000_d963
    dec word ptr [5d54h]
LAB_1000_d963:
    mov AX,1h
...
sub_1DAAE proc near
    ...
    jmp LAB_1000_dae3
LAB_1000_dadd:
    mov word ptr [5d50h],0h
LAB_1000_dae3:
    mov AX,0fh
    push AX
    mov AX,4h
    sub AX,word ptr [0e5ah]
    push AX
    push word ptr [814h]
    call _sub_1CF64
    add SP,6h
...
sub_1DB9C proc near
    push BP
    mov BP,SP
    cmp word ptr [0e5ah],2h
    jnz LAB_1000_dbb3
    mov word ptr [0e5ah],1h
    shl word ptr [814h],1h
    call sub_1DAAE
LAB_1000_dbb3:
    mov SP,BP
    pop BP
...
sub_1DBE0 proc near
    push BP
    mov BP,SP
    mov byte ptr [96e3h],0h
    mov byte ptr [96e2h],8dh
    mov AX,96e2h
    push AX
    push AX
    mov AX,10h
...
sub_1E11C proc near
    ...
    call far ptr gfx_jump_3b_clearBuf
    call nullsub_1
    mov word ptr [6130h],0h
    mov word ptr [6128h],0fa00h
LAB_1000_e148:
    mov DI,word ptr [6130h]
    call far ptr gfx_jump_3a_getRowOffset
    mov [612ch],AX
    call sub_1E262
    mov DI,word ptr [612ch]
    mov BP,5fe8h
    mov BX,word ptr [6130h]
    call far ptr gfx_jump_33_fillRow
    mov DI,word ptr [612ch]
    call far ptr gfx_jump_41
    inc word ptr [6130h]
    sub word ptr [6128h],140h
    jnz LAB_1000_e148
    pop BP
    pop ES
    pop SI
...
sub_1E28C proc near
    ...
    mov AX,66bfh
    mov [64ach],AX
    mov byte ptr [64b0h],0h
    mov byte ptr [64b1h],0h
    cmp SI,word ptr [64aah]
    jc LAB_1000_e2b8
    push BX
    push CX
    push DX
...
LAB_1000_e2b8:
    lodsw
    mov [64b8h],AX
    mov byte ptr [64bah],8h
    mov byte ptr [64bbh],1h
    or AL,AL
    jns LAB_1000_e2d0
    dec byte ptr [64bbh]
    neg AL
...
; ------------------------------seg000:0xe2d3------------------------------
sub_1E2D3 proc near
    mov byte ptr [64b2h],9h
    mov word ptr [64b4h],1ffh
    mov DX,100h
    mov word ptr [64b6h],DX
    mov AX,0ffffh
    xor BX,BX
    mov CX,800h
LAB_1000_e2ed:
...
; ------------------------------seg000:0xe309------------------------------
sub_1E309 proc near
    cmp byte ptr [64bbh],0h
    jz LAB_1000_e314
    shr word ptr [64aeh],1h
LAB_1000_e314:
    mov AX,[64ach]
    mov word ptr [64ach],SP
    mov SP,AX
    mov DX,word ptr [64b6h]
LAB_1000_e321:
    cmp byte ptr [64b0h],0h
    jnz LAB_1000_e349
    call sub_1E382
    cmp AL,90h
    jz LAB_1000_e335
...
LAB_1000_e389:
    ...
    jmp BP
LAB_1000_e38c:
    mov BX,word ptr [64b8h]
    mov CL,10h
    mov CH,byte ptr [64bah]
    sub CL,CH
    shr BX,CL
    mov CL,CH
LAB_1000_e39c:
    cmp CL,byte ptr [64b2h]
    jge LAB_1000_e3c2
    cmp SI,word ptr [64aah]
    jc LAB_1000_e3b5
    push BX
...
LAB_1000_e3b5:
    ...
    jmp LAB_1000_e39c
LAB_1000_e3c2:
    sub CL,byte ptr [64b2h]
    mov byte ptr [64bah],CL
    mov AX,BX
    and AX,word ptr [64b4h]
    mov CX,AX
    cmp AX,DX
    jl LAB_1000_e3e0
    mov CX,DX
    mov AX,[64bch]
    mov BL,byte ptr [64beh]
    push BX
LAB_1000_e3e0:
    mov BX,AX
    add BX,AX
...
LAB_1000_e3f5:
    ...
    inc DX
    cmp DX,word ptr [64b4h]
    jle LAB_1000_e41e
    inc byte ptr [64b2h]
    stc
    rcl word ptr [64b4h],1h
LAB_1000_e41e:
    mov AL,[64b2h]
    cmp AL,byte ptr [64b3h]
    jle LAB_1000_e42a
    call sub_1E2D3
LAB_1000_e42a:
    mov word ptr [64bch],CX
    jmp LAB_1000_e389
sub_1E382 endp
; ------------------------------seg000:0xe42e------------------------------
; ------------------------------seg000:0xe432------------------------------
...
LAB_1000_e468:
    and SP,0fffeh
    mov word ptr SS:[613ah],SP
    mov word ptr SS:[6136h],SP
    mov AX,SI
    mov CL,4h
    shl AX,CL
    dec AX
...
__cinit proc near
    ...
    mov AX,3500h
    int 21h
    mov word ptr [6199h],BX
    mov word ptr [619bh],ES
    push CS
    pop DS
    mov AX,2500h
    mov DX,0e4c6h
    ...
    push SS
    pop DS
    mov CX,word ptr [6336h]
    or CX,CX
    jz LAB_1000_e538
    mov ES,word ptr [61abh]
    mov SI,word ptr ES:[2ch]
    lds AX,dword ptr [6338h]
    mov DX,DS
    xor BX,BX
    call far ptr [6334h]
    jnc LAB_1000_e527
...
LAB_1000_e579:
    mov BX,4h
LAB_1000_e57c:
    and byte ptr [BX + 61b4h],0bfh
    mov AX,4400h
    int 21h
    jc LAB_1000_e592
    test DL,80h
    jz LAB_1000_e592
    or byte ptr [BX + 61b4h],40h
LAB_1000_e592:
    dec BX
    jns LAB_1000_e57c
    mov SI,6340h
...
LAB_1000_e5e6:
    ...
    mov BX,5h
LAB_1000_e5ec:
    db 0f6h, 87h, 0b4h, 61h, 01h  ; TEST byte ptr [BX + 0...,0x1                 ;= ??
    jz LAB_1000_e5f7
    mov AH,3eh
    int 21h
LAB_1000_e5f7:
...
LAB_1000_e611:
    push DS
    lds DX,dword ptr [6199h]
    mov AX,2500h
    int 21h
    pop DS
    cmp byte ptr [61d6h],0h
    jz LAB_1000_e630
    push DS
    mov AL,[61d7h]
    lds DX,dword ptr [61d8h]
    mov AH,25h
    int 21h
    pop DS
LAB_1000_e630:
...
LAB_1000_e79b:
    ...
    cbw
    mov BX,AX
    test byte ptr [BX + 61b4h],80h
    jnz LAB_1000_e7ee
    test word ptr [BP + -4h],1ffh
    jnz LAB_1000_e7ee
    cmp word ptr [BP + -4h],0h
    jnz LAB_1000_e7b8
    jmp LAB_1000_e87e
...
LAB_1000_e7d4:
    ...
    jmp LAB_1000_e90d
LAB_1000_e7dc:
    sub word ptr [BP + -4h],DI
    add word ptr [BP + 4h],DI
    cmp word ptr [BP + -4h],0h
    jnz LAB_1000_e7eb
    jmp LAB_1000_e87e
LAB_1000_e7eb:
...
_segread proc near
    ...
    mov BP,SP
    mov BX,word ptr [BP + 4h]
    mov word ptr [BX + 6h],DS
    mov word ptr [BX],ES
    mov word ptr [BX + 2h],CS
    mov word ptr [BX + 4h],SS
    mov SP,BP
    pop BP
    ret
_segread endp
...
__aNldiv proc near
    ...
    neg AX
    neg DX
    db 1Dh, 00h, 00h ; sbb AX,0h (force imm16 encoding)
    mov word ptr [BP + 6h],AX
    mov word ptr [BP + 4h],DX
LAB_1000_ec34:
    mov AX,word ptr [BP + 0ah]
...
LAB_1000_eea3:
    ...
    db 90h
LAB_1000_eeaa:
    test byte ptr [SI + 6h],2h
    jz LAB_1000_eeb6
    or byte ptr [SI + 6h],20h
    jmp LAB_1000_eea3
LAB_1000_eeb6:
    or byte ptr [SI + 6h],1h
    mov BX,word ptr [BP + -2h]
...
__openfile proc near
    ...
    mov AL,byte ptr [BX]
    cbw
    db 3Dh, 61h, 00h ; cmp AX,61h (force imm16 encoding)
    jz LAB_1000_efa2
    db 3Dh, 72h, 00h ; cmp AX,72h (force imm16 encoding)
    jz LAB_1000_ef8a
    db 3Dh, 77h, 00h ; cmp AX,77h (force imm16 encoding)
    jz LAB_1000_ef98
LAB_1000_ef84:
    sub AX,AX
    jmp LAB_1000_f056
...
LAB_1000_efb7:
    ...
    mov AL,byte ptr [BX]
    cbw
    db 3Dh, 2Bh, 00h ; cmp AX,2bh (force imm16 encoding)
    jz LAB_1000_efa8
    db 3Dh, 62h, 00h ; cmp AX,62h (force imm16 encoding)
    jz LAB_1000_efe6
    db 3Dh, 74h, 00h ; cmp AX,74h (force imm16 encoding)
    jnz LAB_1000_efed
    mov AX,DI
    test AX,0c000h
    jnz LAB_1000_efed
...
__getstream proc near
    ...
    push SI
    mov SI,61feh
    mov CX,word ptr [6316h]
LAB_1000_f0d8:
    db 0f6h, 44h, 06h, 83h  ; TEST byte ptr [SI + 0...,0x83                ;= ??
    jnz LAB_1000_f0f4
    sub AX,AX
    db 89h, 44h, 02h  ; MOV word ptr [SI + 0...,AX                  ;= ??
    db 88h, 44h, 06h  ; MOV byte ptr [SI + 0...,AL                  ;= ??
    db 89h, 44h, 04h  ; MOV word ptr [SI + 0...,AX                  ;= ??
    mov word ptr [SI],AX
    db 0c6h, 44h, 07h, 0ffh  ; MOV byte ptr [SI + 0...,0xff                ;= ??
    mov AX,SI
    jmp LAB_1000_f0ff
    db 90h
LAB_1000_f0f4:
...
LAB_1000_f4c0:
    ...
    jnz LAB_1000_f533
    call _stackavail
    db 3Dh, 0A8h, 00h ; cmp AX,0a8h (force imm16 encoding)
    jbe LAB_1000_f539
    sub SP,2h
    mov BX,SP
    mov DX,200h
...
LAB_1000_f6a4:
    ...
    cmp DX,CX
    jz LAB_1000_f6b3
    mov word ptr ES:[632ah],DS
LAB_1000_f6b3:
    mov word ptr [BX + 2h],DI
    ret
LAB_1000_f6b7:
    mov byte ptr ES:[6330h],2h
LAB_1000_f6bd:
    db 3Dh, 0FEh, 0FFh ; cmp AX,0fffeh (force imm16 encoding)
    jz LAB_1000_f6e7
    mov DI,SI
    add SI,AX
LAB_1000_f6c6:
...
LAB_1000_f6e7:
    ...
    jmp LAB_1000_f706
LAB_1000_f6f2:
    dec byte ptr ES:[6330h]
    jz LAB_1000_f70a
    mov AX,DS
    mov DI,SS
    cmp AX,DI
    jz LAB_1000_f706
    mov DS,word ptr ES:[6326h]
LAB_1000_f706:
    mov SI,word ptr [BX]
    jmp LAB_1000_f6c6
LAB_1000_f70a:
