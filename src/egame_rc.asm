...
; ------------------------------seg000:0x1a17------------------------------
; ------------------------------seg000:0x1a18------------------------------
; drawWeaponAmmo moved to egame1.c
; ------------------------------seg000:0x1a87------------------------------
; ------------------------------seg000:0x1a88------------------------------
; ------------------------------seg000:0x1b36------------------------------
; ------------------------------seg000:0x1b37------------------------------
...
loc_148D1:
    ...
    call makeSound
    add SP,04h
    mov word ptr [_word_380CA],0C000h
    mov byte ptr [_word_380D0+0Dh],01h
loc_14958:
...
loc_14EC6:
    ...
    cmp word ptr [_word_3BEBE],AX
    jnz loc_14F05
    cmp word ptr [_word_380CC],00h
    jz loc_14EE1
    mov word ptr [_word_380CC],00h
    mov byte ptr [_word_380D0+0Dh],01h
loc_14EE1:
    cmp word ptr [_word_380CA],00h
    jl loc_14EF3
...
loc_14F33:
    ...
    cmp byte ptr [_word_380D0+0Dh],00h
    jz loc_14F40
    call rebuildOrientation
loc_14F40:
    mov AX,[_word_380D0]
...
fireAirThreat proc near
    ...
    push word ptr [SI + offset word_3B206]
    push word ptr [SI + offset word_3B204]
    call computeThreatRangeBearing
    add SP,0ch
    mov word ptr [BP + -1ch],AX
...
; setDrawColor moved to egame1.c
...
; _drawNumber - now in C (egame1.c)
; ------------------------------seg000:0xa1b0------------------------------
; _drawTacticalMap - now in C (egame2.c)
; ------------------------------seg000:0xa934------------------------------
...
; ------------------------------seg000:0xa9f7------------------------------
; ------------------------------seg000:0xa9f8------------------------------
; updateTargetLock moved to egui.c
...
; ------------------------------seg000:0xcf63------------------------------
; ------------------------------seg000:0xcf64------------------------------
; _clampRange - now in C (egame2.c)
; ------------------------------seg000:0xcf8d------------------------------
; _rangeApprox - now in C (egame2.c)
; ------------------------------seg000:0xcfa6------------------------------
; ------------------------------seg000:0xd007------------------------------
; ------------------------------seg000:0xd008------------------------------
; _computeBearing - now in C (egame1.c)
